...
<template>
    ...
    <!--Succes alert-->
    <div class="grid grid-cols-6" v-if="showSucces">
        <div
            class="col-start-6 flex items-start sm:items-center p-4 m-4 text-sm text-fg-success-strong rounded-base bg-success-medium border border-success-subtle"
            role="alert">
    ...
    <!--Error alert-->
    <div class="grid grid-cols-6" v-if="showError">
        <div
             class="col-start-6 flex items-start sm:items-center p-4 m-4 text-sm text-fg-danger-strong rounded-base bg-danger-soft border border-danger-subtle"
             role="alert">
            <svg class="w-4 h-4 me-2 shrink-0 mt-0.5 sm:mt-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                 width="24" height="24" fill="none" viewBox="0 0 24 24">
                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <p><span class="font-medium me-1">Submit was unsucessfull</span> Check logs to see error or contact admin
            </p>
        </div>
    </div>
